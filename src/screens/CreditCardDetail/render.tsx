    ...
    <View style={styles.container}>
      ...
      <View style={styles.containerDetail}>
        ...
        <LabelInfo
          ...
          detail={transformDate(cardInfo.date_release).toString()}
        />
        <LabelInfo
          label="Fecha revisión"
          detail={transformDate(cardInfo.date_revision).toString()}
        />
      </View>

      <Button
        accessibilityText='Botón editar Tarjeta'
        name="Editar"
      ...
      />
      <Button
        accessibilityText='Botón eliminar Tarjeta'
        testID="btn-eliminate"
        name="Eliminar"
